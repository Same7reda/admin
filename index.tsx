...
import { Logo, Input, Button, Label, Spinner, Card } from '../components/ui';
    ...
    return (
        <div className="w-full max-w-2xl">
            ...
            <Card className="p-8">
                 ...
                 <p className="text-gray-600 dark:text-gray-400 mb-6">أداة توليد أكواد التفعيل لنظام TutorKit Pro.</p>

                <div className="space-y-4">
                    <div>
                        <Label htmlFor="numKeys">عدد الأكواد المطلوب توليدها:</Label>
                        <Input
                            id="numKeys"
                            type="number"
                            value={numKeys}
                ...
                {generatedKeys.length > 0 && (
                    <div className="mt-6">
                        <Label>الأكواد الجديدة:</Label>
                        <textarea
                            readOnly
                            className="w-full h-48 p-2 border rounded-md bg-gray-100 dark:bg-gray-700 font-mono text-sm"
                            value={generatedKeys.join('\n')}
                        />
                        <p className="text-xs text-gray-500 mt-1">يمكنك نسخ هذه الأكواد وتوزيعها على المستخدمين.</p>
                    </div>
                )}
            </Card>
        </div>
...
const AdminApp: React.FC = () => {
    ...
    const renderContent = () => {
        ...
        return <p className="text-red-500 text-center p-4">التحقق من الصلاحيات...</p>;
    }
